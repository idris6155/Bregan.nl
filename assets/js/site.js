(() => {
  ...
  function productVisual(p){
    ...
    return `<div class="product-visual branded-bag-visual"><img class="brand-bag-photo" src="${bag}" alt="Bregan packaging" loading="lazy"></div>`;
  }
